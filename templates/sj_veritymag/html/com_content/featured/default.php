...
<div class="items-leading row cleafix">
	<?php foreach ($this->lead_items as &$item) : ?>
        
		<div class="item leading-<?php echo $leadingcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?> col-sm-<?php echo round((12 / $this->columns));?> clearfix"
