...
if ($_REQUEST['option'] == 'com_k2' && $_REQUEST['view'] == 'item') {
	return;	
}
    ...
    <div class="moduletable <?php echo $class_suffix; ?>">
        ...
        <div id="<?php echo $tag_id ; ?>"
            ...
            <?php if($title_slider_display) { ?>
                <div class="heading-title hidden-xs"><?php echo $title_slider; ?></div>
            <?php } ?>
                                ...
                                <div class="item-info">
                                    <?php if( $options->item_title_display == 1 ){?>
                                        <div class="item-title">
                                            <h3><a href="<?php echo $item->link;?>" title="<?php echo $item->title ?>" <?php echo K2ExtrasliderHelper::parseTarget($params->get('item_link_target')); ?>>
