							...
							<div class="mgsl-item-content">
								<?php if ($item->normal_title != '') { ?>
									<div class="mgsl-item-title">
										<h3><a href="<?php echo $item->link; ?>"  <?php echo SjK2MegaHelper::parseTarget($options->item_link_target); ?>
										   title="<?php echo $item->title; ?>">
                                    ...
                                    <span class="item-author"><?php echo $item->author;?></span>
                                </div>
								<?php } ?>
...
<?php if ($options->theme == 'theme1') { ?>
	...
	<?php $w1 = $options->module_width - $options->imgcfg_width - 60;
	($w1 > 0) ? $w1 : 0; ?>
	width:<?php echo $w1 ?>px;
	}
    #sjk2megaslider_<?php echo $instance; ?> .mgsl-wrap.theme1 .mgsl-control{
	<?php $w1 = $options->module_width - $options->imgcfg_width -30;
	($w1 > 0) ? $w1 : 0; ?>
	width:<?php echo $w1 ?>px;
	}
