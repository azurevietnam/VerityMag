...
?>
	...
	<div id="<?php echo $uniquied?>" class="sj-basic-news">
		<div class="bs-items">
			...
			?>
			<div class="bs-item cf <?php echo $show_line.' '.$first_class .' '.$last_class; ?>">
				<?php if($img){?>
				<div class="bs-image">
				...
				<div class="bs-content">
					...
					<div class="bs-title">
						<h3><a href="<?php echo $item->link ?>" title="<?php echo $item->title; ?>" <?php echo SjBasicNewsHelper::parseTarget($params->get('link_target')); ?>>
                    ...
                    <?php if($params->get('item_date_display') == 1 ){ ?>
						<span class="bs-date"><?php echo JText::sprintf( JHtml::_('date', $item->created, JText::_('DATE_FORMAT_TEMPLATE')));  ?></span>
						<?php }?>
                    <?php if($item->author){ ?>

                        <span class="bs-author"><?php echo JText::_('K2_AUTHOR_BY') .' '.$item->author;  ?></span>
                    <?php }?>
					</div>
					<?php }?>
