...
function modChrome_ytmod($module, &$params, &$attribs){ ?>
	...
	$badge = preg_match ('/badge/', $params->get('moduleclass_sfx')) ? "<span class=\"badge\"></span>\n" : "";
        $string_title1=strstr($module->title, "|" );
        
        $string_title2=str_replace("|", "", $string_title1);
        $string_pretitle=str_replace($string_title1, "", $module->title);
        
        $string_subtitle = preg_match ('/|/', $module->title) ? "<span class=\"subtitle\">$string_title2</span>\n" : "";
...
<h3 class="modtitle"><span class="modtitle-inner"><?php echo $icons; ?><?php echo $string_pretitle; ?><?php echo $string_subtitle; ?><?php echo $badge; ?></span></h3>
	    <?php endif; ?>
