...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <?php if($params->get('itemCategory')): ?>
      <div><a class="moduleItemCategory" href="<?php echo $item->categoryLink; ?>"><?php echo $item->categoryname; ?></a></div>
      <?php endif; ?>
    <?php if($params->get('itemDateCreated')): ?>
      <span class="moduleItemDateCreated"><?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_TEMPLATE_DAILY_DIGEST')); ?></span>
      <?php endif; ?>
    <?php if($params->get('itemTitle')): ?>
      <a class="moduleItemTitle" href="<?php echo $item->link; ?>"><?php echo K2HelperUtilities::wordLimit($item->title, 6,'') ?></a>
      <?php endif; ?>
        </div>
    <?php endif; ?>
