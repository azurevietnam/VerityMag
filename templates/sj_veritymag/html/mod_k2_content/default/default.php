...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
    ...
    <?php if($params->get('itemTitle')): ?>
      <h3><a class="moduleItemTitle" href="<?php echo $item->link; ?>"><?php echo K2HelperUtilities::wordLimit($item->title, 7,'') ?></a></h3>
      <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <?php endif; ?>
        ...
        <span class="moduleItemDateCreated"> <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_TEMPLATE')); ?></span>
    <?php endif; ?>
