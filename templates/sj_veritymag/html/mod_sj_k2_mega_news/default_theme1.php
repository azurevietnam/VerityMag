		...
		<ul class="other-link">
			<?php foreach ($other_items as $item) { ?>
				<li>
                    ...
                    <?php if ($params->get('item_created_other_display', 1) || $params->get('item_author_other_display', 1)) { ?>
                        <div class="info">
                            <?php if ($params->get('item_created_other_display', 1)) {?>
                                <span class="item-created"><?php echo JText::sprintf( JHtml::_('date', $item->created, JText::_('DATE_FORMAT_TEMPLATE')));?></span>
                            <?php } ?>
                            <?php if ($params->get('item_author_other_display', 1)) {?>
                                <div class="item-author">
                                    <?php echo JText::_('K2_AUTHOR_BY'); ?>
