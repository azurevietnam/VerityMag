...
<div class="catItemView sj-secondary group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php else: ?>
	<?php if(($this->item->params->get('catItemImage') || $this->item->image || $this->item->params->get('catItemCategory')) && ($this->params->get('secondaryImgSize'))!='none'): ?>
