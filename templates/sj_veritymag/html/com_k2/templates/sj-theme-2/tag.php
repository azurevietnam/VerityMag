...
<div id="k2Container" class="tagView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="componentheading<?php echo $this->params->get('pageclass_sfx')?>">
		<h1 class="page-title"><?php echo $this->escape($this->params->get('page_title')); ?></h1>
	</div>
	<?php endif; ?>
	...
	<div class="itemList">
		...
		<div class="catItemView">
			<?php if($item->params->get('tagItemCategory') || $item->params->get('tagItemImage',1)): ?>
            ...
            <aside class="article-aside">
					<dl class="article-info  muted">
                        ...
                        <?php if($item->params->get('tagItemDateCreated',1)): ?>
                            <dd class="create"><?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_TEMPLATE')); ?></dd>
                        <?php endif; ?>
