...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="componentheading<?php echo $this->params->get('pageclass_sfx')?>">
		<h1 class="page-title"><span class="modtitle-inner"><?php echo $this->escape($this->params->get('page_title')); ?></span></h1>
	</div>
	<?php endif; ?>
	...
	<div class="itemList">
		...
		<div id="itemListSecondary" class="row">
			...
			<div class="itemContainer col-sm-<?php echo number_format(12/$this->params->get('num_secondary_columns')) ?> <?php echo $lastContainer; ?>">
				<?php
					// Load category_item.php by default
					$this->item=$item;
