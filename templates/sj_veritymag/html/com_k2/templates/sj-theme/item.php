...
<dt></dt>
				...
				<dd>
					...
					<span><?php echo JText::_('K2_AUTHOR_BY').' '; ?></span>
				...
				<dd>
					<span class="itemDateCreated">
						...
						<?php echo JHTML::_('date', $this->item->created , JText::_('DATE_FORMAT_TEMPLATE')); ?>
					</span>
				</dd>
				<?php endif; ?>
  ...
  <div class="itemToolbar">
	...
	<?php endif; ?>
        ...
        <?php if($this->item->params->get('itemVideo') && !empty($this->item->video)){ ?>
		  ...
		  <?php }else {?>
			  <!-- Item Image -->
				<?php if(($this->item->params->get('itemImage') && ($this->item->image==0)) || ($this->item->params->get('itemCategory'))){ ?>
<?php if($this->item->params->get('itemImage') && ($this->item->image==0)) {?>
	...
	<div class="itemContentFooter">
		...
		<span class="itemDateModified">
			<?php echo JText::_('K2_LAST_MODIFIED_ON'); ?> <?php echo JHTML::_('date', $this->item->modified, JText::_('DATE_FORMAT_TEMPLATE')); ?>
		</span>
		<?php endif; ?>
  ...
  <!-- Latest items from author -->
	<div class="itemAuthorLatest first">
		<h3 ><?php echo JText::_('K2_LATEST_FROM'); ?> <span class="text-color"><?php echo $this->item->author->name; ?></span></h3>
		<ul>
  ...
  <?php if($this->item->params->get('itemRelated') && isset($this->relatedItems)): ?>
	...
	<div class="itemRelated span12">
		...
		<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; echo ' col-sm-'.number_format(12/$this->item->params->get('itemRelatedLimit'))?>">
				...
				<div class="itemRelCat"><a href="<?php echo $item->category->link ?>"><?php echo $item->category->name; ?></a></div>
				<?php endif; ?>
