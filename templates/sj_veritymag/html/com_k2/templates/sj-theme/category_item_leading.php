...
<div class="catItemView sj-leading group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php else: ?>
	<?php if($this->item->params->get('catItemImage') || $this->item->image || $this->item->params->get('catItemCategory')): ?>
	  <!-- Item Image -->
		    ...
		    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
				...
				<?php 
					...
					if (!empty( $src)) {								
						...
						$thumb_img = yt_placehold($placehold_size['leading'],$this->item->title,$this->item->title);
					}	
					echo $thumb_img;
				?>
        ...
        <aside class="article-aside">
			<dl class="article-info  muted">
				...
				<?php if($this->item->params->get('catItemDateCreated')): ?>
					<dd class="create"><?php echo JHTML::_('date', $this->item->created , JText::_('DATE_FORMAT_TEMPLATE')); ?></dd>
				<?php endif; ?>
  ...
  <div class="catItemImageGallery">
	  <h4><?php echo JText::_('K2_IMAGE_GALLERY_ME'); ?></h4>
