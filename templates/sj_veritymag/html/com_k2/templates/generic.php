	...
	<div class="genericItemList">
		...
		<div class="genericItemView">
		  ...
		  <div class="genericItemBody">
			  <?php if($this->params->get('genericItemImage') && (isset($item->imageGeneric))): ?>
			  <!-- Item Image -->
			  <div class="genericItemImageBlock">
				  <span class="genericItemImage">
				    <a href="<?php echo $item->link; ?>" title="<?php if(!empty($item->image_caption)) echo K2HelperUtilities::cleanHtml($item->image_caption); else echo K2HelperUtilities::cleanHtml($item->title); ?>">
                        ...
                        <?php 
                            ...
                            if (!empty( $src)) {								
                                $thumb_img = '<img src="'.$src.'" alt="'.((!empty($item->image_caption)) ? K2HelperUtilities::cleanHtml($item->image_caption) : K2HelperUtilities::cleanHtml($item->title)).'" />';
                ...
                <?php if($this->params->get('genericItemCategory')): ?>
                    ...
                    <div class="genericItemCategory">
                        <h3><a href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a></h3>
                    </div>
                <?php endif; ?>
				  <div class="clr"></div>
			  </div>
			  ...
			  <?php endif; ?>
				...
				<span class="genericItemDateCreated">
					<?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_TEMPLATE')); ?>
				</span>
				<?php endif; ?>
			  <div class="clr"></div>
		  </div>
