...
abstract class SjK2MegaHelper extends SjK2MegaBaseHelper {
	public static function getList(&$params)
	{
		...
		$item_title_display = $params->get('item_title_display', 1);
		$item_title_max_characs = $params->get('item_title_max_characs', 50);
		$item_title_ending_char = $params->get('item_title_ending_char', '');
		$item_desc_display = $params->get('item_desc_display', 1);		
		$item_desc_max_characs = $params->get('item_desc_max_characs', 100);
		$item_desc_ending_char = $params->get('item_desc_ending_char', '');
		
		
		
		$nav_titlte_max_chars = $params->get('nav_titlte_max_chars', 30);		
		$nav_title_ending_char = $params->get('nav_title_ending_char', '');	
		$nav_description_max_characters = $params->get('nav_description_max_characters', 50);
		$nav_desc_ending_char = $params->get('nav_desc_ending_char', '');		
		...
		if (count($items))
		{
			...
			foreach ($items as $item)
			{
				...
				$item->normal_title = $item_title_display ? self::truncate($item->title, $item_title_max_characs, $item_title_ending_char) : '';	
				
				$item->smalltitle = self::truncate($item->title, $nav_titlte_max_chars, $nav_title_ending_char);	
				...
				$item->Introtext = $item_desc_display ? self::truncate($item->_introtext, $item_desc_max_characs, $item_desc_ending_char) : '';	
				
				$item->SmallIntrotext = self::truncate($item->_introtext, $nav_description_max_characters, $nav_desc_ending_char);	
				// Author
